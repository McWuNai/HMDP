...
CREATE TABLE `tb_blog`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT hmdpENT '主键',
  `shop_id` bigint(20) NOT NULL hmdpENT '商户id',
  `user_id` bigint(20) UNSIGNED NOT NULL hmdpENT '用户id',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL hmdpENT '标题',
  `images` varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL hmdpENT '探店的照片，最多9张，多张以\",\"隔开',
  `content` varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL hmdpENT '探店的文字描述',
  `liked` int(8) UNSIGNED NULL DEFAULT 0 hmdpENT '点赞数量',
  `Comments` int(8) UNSIGNED NULL DEFAULT NULL hmdpENT '评论数量',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP hmdpENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP hmdpENT '更新时间',
...
CREATE TABLE `tb_blog_Comments`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT hmdpENT '主键',
  `user_id` bigint(20) UNSIGNED NOT NULL hmdpENT '用户id',
  `blog_id` bigint(20) UNSIGNED NOT NULL hmdpENT '探店id',
  `parent_id` bigint(20) UNSIGNED NOT NULL hmdpENT '关联的1级评论id，如果是一级评论，则值为0',
  `answer_id` bigint(20) UNSIGNED NOT NULL hmdpENT '回复的评论id',
  `content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL hmdpENT '回复的内容',
  `liked` int(8) UNSIGNED NULL DEFAULT NULL hmdpENT '点赞数',
  `status` tinyint(1) UNSIGNED NULL DEFAULT NULL hmdpENT '状态，0：正常，1：被举报，2：禁止查看',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP hmdpENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP hmdpENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tb_follow`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT hmdpENT '主键',
  `user_id` bigint(20) UNSIGNED NOT NULL hmdpENT '用户id',
  `follow_user_id` bigint(20) UNSIGNED NOT NULL hmdpENT '关联的用户id',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP hmdpENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `tb_seckill_voucher`  (
  `voucher_id` bigint(20) UNSIGNED NOT NULL hmdpENT '关联的优惠券的id',
  `stock` int(8) NOT NULL hmdpENT '库存',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP hmdpENT '创建时间',
  `begin_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' hmdpENT '生效时间',
  `end_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' hmdpENT '失效时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP hmdpENT '更新时间',
  PRIMARY KEY (`voucher_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci hmdpENT = '秒杀优惠券表，与优惠券是一对一关系' ROW_FORMAT = Compact;
...
CREATE TABLE `tb_shop`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT hmdpENT '主键',
  `name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL hmdpENT '商铺名称',
  `type_id` bigint(20) UNSIGNED NOT NULL hmdpENT '商铺类型的id',
  `images` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL hmdpENT '商铺图片，多个图片以\',\'隔开',
  `area` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL hmdpENT '商圈，例如陆家嘴',
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL hmdpENT '地址',
  `x` double UNSIGNED NOT NULL hmdpENT '经度',
  `y` double UNSIGNED NOT NULL hmdpENT '维度',
  `avg_price` bigint(10) UNSIGNED NULL DEFAULT NULL hmdpENT '均价，取整数',
  `sold` int(10) UNSIGNED ZEROFILL NOT NULL hmdpENT '销量',
  `Comments` int(10) UNSIGNED ZEROFILL NOT NULL hmdpENT '评论数量',
  `score` int(2) UNSIGNED ZEROFILL NOT NULL hmdpENT '评分，1~5分，乘10保存，避免小数',
  `open_hours` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL hmdpENT '营业时间，例如 10:00-22:00',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP hmdpENT '创建时间',
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP hmdpENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `tb_shop_type`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT hmdpENT '主键',
  `name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL hmdpENT '类型名称',
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL hmdpENT '图标',
  `sort` int(3) UNSIGNED NULL DEFAULT NULL hmdpENT '顺序',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP hmdpENT '创建时间',
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP hmdpENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tb_sign`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT hmdpENT '主键',
  `user_id` bigint(20) UNSIGNED NOT NULL hmdpENT '用户id',
  `year` year NOT NULL hmdpENT '签到的年',
  `month` tinyint(2) NOT NULL hmdpENT '签到的月',
  `date` date NOT NULL hmdpENT '签到的日期',
  `is_backup` tinyint(1) UNSIGNED NULL DEFAULT NULL hmdpENT '是否补签',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `tb_user`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT hmdpENT '主键',
  `phone` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL hmdpENT '手机号码',
  `password` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' hmdpENT '密码，加密存储',
  `nick_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' hmdpENT '昵称，默认是用户id',
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' hmdpENT '人物头像',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP hmdpENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP hmdpENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `tb_user_info`  (
  `user_id` bigint(20) UNSIGNED NOT NULL hmdpENT '主键，用户id',
  `city` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' hmdpENT '城市名称',
  `introduce` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL hmdpENT '个人介绍，不要超过128个字符',
  `fans` int(8) UNSIGNED NULL DEFAULT 0 hmdpENT '粉丝数量',
  `followee` int(8) UNSIGNED NULL DEFAULT 0 hmdpENT '关注的人的数量',
  `gender` tinyint(1) UNSIGNED NULL DEFAULT 0 hmdpENT '性别，0：男，1：女',
  `birthday` date NULL DEFAULT NULL hmdpENT '生日',
  `credits` int(8) UNSIGNED NULL DEFAULT 0 hmdpENT '积分',
  `level` tinyint(1) UNSIGNED NULL DEFAULT 0 hmdpENT '会员级别，0~9级,0代表未开通会员',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP hmdpENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP hmdpENT '更新时间',
...
CREATE TABLE `tb_voucher`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT hmdpENT '主键',
  `shop_id` bigint(20) UNSIGNED NULL DEFAULT NULL hmdpENT '商铺id',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL hmdpENT '代金券标题',
  `sub_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL hmdpENT '副标题',
  `rules` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL hmdpENT '使用规则',
  `pay_value` bigint(10) UNSIGNED NOT NULL hmdpENT '支付金额，单位是分。例如200代表2元',
  `actual_value` bigint(10) NOT NULL hmdpENT '抵扣金额，单位是分。例如200代表2元',
  `type` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 hmdpENT '0,普通券；1,秒杀券',
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 hmdpENT '1,上架; 2,下架; 3,过期',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP hmdpENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP hmdpENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tb_voucher_order`  (
  `id` bigint(20) NOT NULL hmdpENT '主键',
  `user_id` bigint(20) UNSIGNED NOT NULL hmdpENT '下单的用户id',
  `voucher_id` bigint(20) UNSIGNED NOT NULL hmdpENT '购买的代金券id',
  `pay_type` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 hmdpENT '支付方式 1：余额支付；2：支付宝；3：微信',
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 hmdpENT '订单状态，1：未支付；2：已支付；3：已核销；4：已取消；5：退款中；6：已退款',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP hmdpENT '下单时间',
  `pay_time` timestamp NULL DEFAULT NULL hmdpENT '支付时间',
  `use_time` timestamp NULL DEFAULT NULL hmdpENT '核销时间',
  `refund_time` timestamp NULL DEFAULT NULL hmdpENT '退款时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP hmdpENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
